  ...
  "node_modules/mdast-util-definitions/index.js"(exports, module) {
    ...
    function getterFactory(cache2) {
      ...
      function getter(identifier) {
        ...
        return id2 && own.call(cache2, id2) ? cache2[id2] : null;
      }
    }
    ...
    function _objectWithoutProperties2(e2, t) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        for (r = 0; r < n2.length; r++)
          o3 = n2[r], t.indexOf(o3) >= 0 || {}.propertyIsEnumerable.call(e2, o3) && (i[o3] = e2[o3]);
      }
      return i;
    }
...
var createIntl = function createIntl2(locale4, localeMap) {
  return {
    getMessage: function getMessage(id2, defaultMessage) {
      return get(localeMap, id2, defaultMessage) || defaultMessage;
    },
    locale: locale4
  };
};
...
function _createForOfIteratorHelper2(o3, allowArrayLike) {
  ...
  if (!it2) {
    if (Array.isArray(o3) || (it2 = _unsupportedIterableToArray2(o3)) || allowArrayLike && o3 && typeof o3.length === "number") {
      if (it2)
        o3 = it2;
      var i = 0;
      var F = function F2() {
...
var o2 = (e2, t) => er(e2, "name", { value: t, configurable: true });
var he = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: l, successNotification: u, errorNotification: y, meta: p, metaData: T, queryMeta: d, mutationMeta: f, liveMode: g, liveParams: m, mutationMode: b, dataProviderName: x, onLiveEvent: C, invalidates: k, undoableTimeout: P, queryOptions: S2, createMutationOptions: B, updateMutationOptions: v, id: L, overtimeOptions: c, optimisticUpdateMap: D, disableServerSideValidation: A = false } = {}) => {
  var J2, ee;
  let { options: R } = ne(), _ = (R == null ? void 0 : R.disableServerSideValidation) || A, h = G(), [K] = form_default.useForm(), j = useForm({ form: K }), { form: U } = j, I = EP({ onMutationSuccess: r || void 0, onMutationError: async (O, te2, ce2) => {
    if (_) {
      s == null || s(O, te2, ce2);
      return;
    }
    let ie = [], ye = U.getFieldsValue();
    ie = Object.keys(ur(ye)).map((ue) => ({ name: Jo(ue), errors: void 0 })), U.setFields(ie);
    let de = O == null ? void 0 : O.errors;
    for (let ue in de) {
      let ne2 = de[ue], fe = [];
      Array.isArray(ne2) && (fe = ne2), typeof ne2 == "string" && (fe = [ne2]), typeof ne2 == "boolean" && ne2 && (fe = ["Field is not valid."]), typeof ne2 == "object" && "key" in ne2 && (fe = [h(ne2.key, ne2.message)]), ie.push({ name: Jo(ue), errors: fe });
    }
    U.setFields([...ie]), s == null || s(O, te2, ce2);
  }, redirect: l, action: e2, resource: t, successNotification: u, errorNotification: y, meta: S(p, T), metaData: S(p, T), queryMeta: d, mutationMeta: f, liveMode: g, liveParams: m, mutationMode: b, dataProviderName: x, onLiveEvent: C, invalidates: k, undoableTimeout: P, queryOptions: S2, createMutationOptions: B, updateMutationOptions: v, id: L, overtimeOptions: c, optimisticUpdateMap: D, autoSave: n2 }), { formLoading: Z2, onFinish: F, queryResult: V, id: H, onFinishAutoSave: N } = I, { warnWhenUnsavedChanges: $, setWarnWhen: Q } = dt(), z2 = a ?? $;
  import_react74.default.useEffect(() => {
    U.resetFields();
  }, [(J2 = V == null ? void 0 : V.data) == null ? void 0 : J2.data, H]);
  let G2 = o2((O) => {
    i && O.key === "Enter" && U.submit();
  }, "onKeyUp"), Y = o2((O, te2) => {
    if (O && z2 && Q(true), n2 != null && n2.enabled) {
      Q(false);
      let ce2 = (n2 == null ? void 0 : n2.onFinish) ?? ((ie) => ie);
      return N(ce2(te2)).catch((ie) => ie);
    }
    return O;
  }, "onValuesChange"), X = { disabled: Z2, onClick: () => {
    U.submit();
  } };
  return { form: j.form, formProps: { ...j.formProps, onFinish: (O) => F(O).catch((te2) => te2), onKeyUp: G2, onValuesChange: Y, initialValues: (ee = V == null ? void 0 : V.data) == null ? void 0 : ee.data }, saveButtonProps: X, ...I, onFinish: async (O) => await F(O ?? j.form.getFieldsValue(true)) };
}, "useForm");
var eo = o2(({ modalProps: e2 = {} } = {}) => {
  let { show: t, close: r, visible: s } = vh({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (n2) => {
    var i;
    (i = e2.onCancel) == null || i.call(e2, n2), r();
  }, open: s, visible: s }, show: t, close: r };
}, "useModal");
var oo = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  var Q, z2;
  let [l, u] = import_react75.default.useState(false), y = Ce(), { resource: p, action: T, identifier: d } = z(a.resource), f = ae(), g = ge(), m = nt(), b = a.action ?? T ?? "", x = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : p && b && e2 ? `modal-${d}-${b}` : void 0, k = he({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: P, formProps: S2, id: B, setId: v, formLoading: L, onFinish: c, autoSaveProps: D } = k, A = G(), { warnWhen: R, setWarnWhen: _ } = dt(), { show: h, close: K, modalProps: j } = eo({ modalProps: { open: t } }), U = j.open || false, I = { modalProps: j, form: P, formLoading: L, formProps: S2, formResult: void 0, formValues: P.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: c, close: K, open: j.open || false, show: h, visible: U };
  import_react75.default.useEffect(() => {
    var G2, Y, X, J2;
    if (l === false && C) {
      let ee = (Y = (G2 = f == null ? void 0 : f.params) == null ? void 0 : G2[C]) == null ? void 0 : Y.open;
      if (typeof ee == "boolean" ? ee && h() : typeof ee == "string" && ee === "true" && h(), x) {
        let O = (J2 = (X = f == null ? void 0 : f.params) == null ? void 0 : X[C]) == null ? void 0 : J2.id;
        O && (v == null || v(O));
      }
      u(true);
    }
  }, [C, f, x, v]), import_react75.default.useEffect(() => {
    var G2;
    l === true && (U && C ? g({ query: { [C]: { ...(G2 = f == null ? void 0 : f.params) == null ? void 0 : G2[C], open: true, ...x && B && { id: B } } }, options: { keepQuery: true }, type: "replace" }) : C && !U && g({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [B, U, h, C, x]);
  let Z2 = { disabled: L, loading: L, onClick: () => {
    P.submit();
  } }, F = (0, import_react75.useCallback)(() => {
    if (D.status === "success" && (n2 != null && n2.invalidateOnClose) && y({ id: B, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: d }), R)
      if (window.confirm(A("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        _(false);
      else
        return;
    v == null || v(void 0), I.close();
  }, [R, D.status]), V = (0, import_react75.useCallback)((G2) => {
    typeof G2 < "u" && (v == null || v(G2)), (!(b === "edit" || b === "clone") || (typeof G2 < "u" || typeof B < "u")) && I.show();
  }, [B]), { visible: H, ...N } = j, $ = { open: H, ...N };
  return { ...k, ...I, show: V, close: F, open: U, formProps: { ...S2, ...k.formProps, onValuesChange: S2 == null ? void 0 : S2.onValuesChange, onKeyUp: S2 == null ? void 0 : S2.onKeyUp, onFinish: async (G2) => {
    await c(G2), r && K(), s && P.resetFields();
  } }, modalProps: { ...$, width: "1000px", okButtonProps: Z2, title: A(`${d}.titles.${a.action}`, `${m(`${a.action} ${((Q = p == null ? void 0 : p.meta) == null ? void 0 : Q.label) ?? ((z2 = p == null ? void 0 : p.options) == null ? void 0 : z2.label) ?? (p == null ? void 0 : p.label) ?? d}`, "singular")}`), okText: A("buttons.save", "Save"), cancelText: A("buttons.cancel", "Cancel"), onCancel: F, forceRender: true }, formLoading: L };
}, "useModalForm");
var so = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let l = Ce(), [u, y] = import_react76.default.useState(false), { visible: p, show: T, close: d } = vh({ defaultVisible: t }), { resource: f, action: g, identifier: m } = z(a.resource), b = ae(), x = ge(), C = a.action ?? g ?? "", k = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), P = typeof e2 == "object" && "key" in e2 ? e2.key : f && C && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${C}` : void 0, S2 = he({ meta: { ...P ? { [P]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: B, formProps: v, formLoading: L, id: c, setId: D, onFinish: A, autoSaveProps: R } = S2;
  import_react76.default.useEffect(() => {
    var F, V, H, N;
    if (u === false && P) {
      let $ = (V = (F = b == null ? void 0 : b.params) == null ? void 0 : F[P]) == null ? void 0 : V.open;
      if (typeof $ == "boolean" ? $ ? T() : d() : typeof $ == "string" && $ === "true" && T(), k) {
        let Q = (N = (H = b == null ? void 0 : b.params) == null ? void 0 : H[P]) == null ? void 0 : N.id;
        Q && (D == null || D(Q));
      }
      y(true);
    }
  }, [P, b, k, D, u]), import_react76.default.useEffect(() => {
    var F;
    u === true && (p && P ? x({ query: { [P]: { ...(F = b == null ? void 0 : b.params) == null ? void 0 : F[P], open: true, ...k && c && { id: c } } }, options: { keepQuery: true }, type: "replace" }) : P && !p && x({ query: { [P]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [c, p, T, d, P, k, u]);
  let _ = G(), { warnWhen: h, setWarnWhen: K } = dt(), j = { disabled: L, onClick: () => {
    B.submit();
  }, loading: L }, U = { recordItemId: c, onSuccess: () => {
    D == null || D(void 0), d();
  } }, I = (0, import_react76.useCallback)(() => {
    if (R.status === "success" && (n2 != null && n2.invalidateOnClose) && l({ id: c, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), h)
      if (window.confirm(_("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        K(false);
      else
        return;
    d(), D == null || D(void 0);
  }, [h]), Z2 = (0, import_react76.useCallback)((F) => {
    typeof F < "u" && (D == null || D(F)), (!(C === "edit" || C === "clone") || (typeof F < "u" || typeof c < "u")) && T();
  }, [c]);
  return { ...S2, show: Z2, close: I, formProps: { form: B, ...S2.formProps, onValuesChange: v == null ? void 0 : v.onValuesChange, onKeyUp: v == null ? void 0 : v.onKeyUp, onFinish: async (F) => {
    await A(F), r && d(), s && B.resetFields();
  } }, drawerProps: { width: "500px", onClose: I, open: p, forceRender: true }, saveButtonProps: j, deleteButtonProps: U, formLoading: L };
}, "useDrawerForm");
var no = o2((e2 = {}) => {
...
var kr = o2((e2, t, r = "eq") => aa(e2, t, r), "getDefaultFilter");
var ct = o2((e2) => {
  let t = [];
  if (Array.isArray(e2))
    e2.sort((r, s) => {
...
var Ce2 = o2(({ to: e2, element: t }) => {
  let { Link: r } = te(), s = Z(), n2 = rt();
  return import_react78.default.createElement(s === "legacy" ? r : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, t);
}, "PaginationLink");
var Tt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: T, syncWithLocation: d, resource: f, successNotification: g, errorNotification: m, queryOptions: b, liveMode: x, onLiveEvent: C, liveParams: k, meta: P, metaData: S2, dataProviderName: B } = {}) => {
  let { tableQueryResult: v, current: L, setCurrent: c, pageSize: D, setPageSize: A, filters: R, setFilters: _, sorters: h, setSorters: K, sorter: j, setSorter: U, createLinkForSyncWithLocation: I, pageCount: Z2, overtime: F } = kR({ permanentSorter: a, permanentFilter: u, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: p, sorters: T, initialSorter: i, initialFilter: l, syncWithLocation: d, resource: f, defaultSetFilterBehavior: y, successNotification: g, errorNotification: m, queryOptions: b, liveMode: x, onLiveEvent: C, liveParams: k, meta: S(P, S2), metaData: S(P, S2), dataProviderName: B }), { syncWithLocation: V } = Kr(), H = d ?? V, N = grid_default.useBreakpoint(), [$] = form_default.useForm(), Q = useForm({ form: $ }), z2 = Vs(x), G2 = s === false ? "off" : "server", Y = ((n2 == null ? void 0 : n2.mode) ?? G2) !== "off", X = S(p == null ? void 0 : p.initial, l), { data: J2, isFetched: ee, isLoading: O } = v;
  import_react77.default.useEffect(() => {
    if (H) {
      let ye = Q.form.getFieldsValue(), se = Object.keys(ye).reduce((de, ue) => {
        let ne2 = R.find((fe) => "field" in fe && fe.field === ue);
        return ne2 && (de[ue] = ne2 == null ? void 0 : ne2.value), de;
      }, {});
      Q.form.setFieldsValue(se);
    }
  }, [H]);
  let te2 = o2((ye, se, de) => {
    ...
    Y && (c == null || c(ye.current || 1), A == null || A(ye.pageSize || 10));
  }, "onChange"), ce2 = o2(async (ye) => {
    if (e2) {
      let se = await e2(ye);
      _(se), Y && (c == null || c(1));
    }
  }, "onFinish"), ie = o2(() => Y ? { itemRender: (ye, se, de) => {
    var ne2;
    let ue = I({ pagination: { pageSize: D, current: ye }, sorters: h, filters: R });
    if (se === "page")
      return (0, import_react77.createElement)(Ce2, { to: ue, element: `${ye}` });
    if (se === "next" || se === "prev")
      return (0, import_react77.createElement)(Ce2, { to: ue, element: de });
    if (se === "jump-next" || se === "jump-prev") {
      let fe = (ne2 = de == null ? void 0 : de.props) == null ? void 0 : ne2.children;
      return (0, import_react77.createElement)(Ce2, { to: ue, element: import_react77.Children.count(fe) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, fe) : fe });
    }
    return de;
  }, pageSize: D, current: L, simple: !N.sm, position: N.sm ? ["bottomRight"] : ["bottomCenter"], total: J2 == null ? void 0 : J2.total } : false, "antdPagination");
  return { searchFormProps: { ...Q.formProps, onFinish: ce2 }, tableProps: { dataSource: J2 == null ? void 0 : J2.data, loading: z2 === "auto" ? O : !ee, onChange: te2, pagination: ie(), scroll: { x: true } }, tableQueryResult: v, sorters: h, sorter: j, filters: R, setSorters: K, setSorter: U, setFilters: _, current: L, setCurrent: c, pageSize: D, setPageSize: A, pageCount: Z2, createLinkForSyncWithLocation: I, overtime: F };
}, "useTable");
var zr = o2(({ autoSubmitClose: e2 = true, ...t } = {}) => {
  let r = Tt({ ...t, successNotification: void 0, errorNotification: void 0 }), s = he({ ...t, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = s, l = { onClick: () => {
    i(void 0);
  } }, u = o2((p) => ({ onClick: () => i(p) }), "editButtonProps"), y = o2((p) => p === n2, "isEditing");
  return { ...r, ...s, formProps: { ...s.formProps, onFinish: async (p) => {
    let T = await s.onFinish(p);
    return e2 && i(void 0), T;
  } }, saveButtonProps: a, cancelButtonProps: l, editButtonProps: u, isEditing: y };
}, "useEditableTable");
var om = o2((e2) => {
  let { queryResult: t, defaultValueQueryResult: r, onSearch: s, options: n2 } = CR(e2);
...
var am = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, onLiveEvent: T, liveParams: d, meta: f, metaData: g, dataProviderName: m }) => {
  let { queryResult: b, options: x } = CR({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, onLiveEvent: T, liveParams: d, meta: S(f, g), metaData: S(f, g), dataProviderName: m });
  return { checkboxGroupProps: { options: x, defaultValue: p }, queryResult: b };
}, "useCheckboxGroup");
var dm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, onLiveEvent: T, liveParams: d, meta: f, metaData: g, dataProviderName: m }) => {
  let { queryResult: b, options: x } = CR({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, onLiveEvent: T, liveParams: d, meta: S(f, g), metaData: S(f, g), dataProviderName: m });
  return { radioGroupProps: { options: x, defaultValue: p }, queryResult: b };
}, "useRadioGroup");
var Tm = o2(({ resource: e2, resourceName: t, mapData: r = o2((p) => p, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: l, dataProviderName: u, onProgress: y } = {}) => {
  let p = G(), { resource: T } = z(e2 ?? t), { mutationResult: d, isLoading: f, handleChange: g } = hh({ resource: (T == null ? void 0 : T.identifier) ?? (T == null ? void 0 : T.name), mapData: r, paparseOptions: s, batchSize: n2, meta: S(a, l), metaData: S(a, l), dataProviderName: u, onFinish: i, onProgress: y ?? (({ totalAmount: m, processedAmount: b }) => {
    if (m > 0 && b > 0) {
      ...
      notification_default.open({ description: x, message: null, key: `${T}-import`, duration: 0 }), b >= m, b === m && setTimeout(() => {
        notification_default.destroy(`${T}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: g, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: f }, mutationResult: d, isLoading: f };
}, "useImport");
var os = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: T, onSearch: d, queryOptions: f, syncWithLocation: g, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: k, meta: P, metaData: S2, dataProviderName: B } = {}) => {
  let { sorters: v, sorter: L, filters: c, current: D, pageSize: A, pageCount: R, setFilters: _, setCurrent: h, setPageSize: K, setSorter: j, setSorters: U, createLinkForSyncWithLocation: I, tableQueryResult: Z2, overtime: F } = kR({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, filters: p, sorters: T, defaultSetFilterBehavior: y, initialCurrent: t, initialPageSize: r, queryOptions: f, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: k, meta: S(P, S2), metaData: S(P, S2), syncWithLocation: g, dataProviderName: B, pagination: s, hasPagination: n2 }), V = n2 === false ? "off" : "server", H = ((s == null ? void 0 : s.mode) ?? V) !== "off", N = grid_default.useBreakpoint(), $ = Vs(x), [Q] = form_default.useForm(), { data: z2, isFetched: G2, isLoading: Y } = Z2, X = o2((O, te2) => {
    H && (h(O), K(te2 || 10));
  }, "onChange"), J2 = o2(async (O) => {
    if (d) {
      let te2 = await d(O);
      return H && (h == null || h(1)), _(te2);
    }
  }, "onFinish"), ee = o2(() => H ? { itemRender: (O, te2, ce2) => {
    var ye;
    let ie = I({ pagination: { pageSize: A, current: O }, sorters: v, filters: c });
    if (te2 === "page")
      return (0, import_react80.createElement)(Ce2, { to: ie, element: `${O}` });
    if (te2 === "next" || te2 === "prev")
      return (0, import_react80.createElement)(Ce2, { to: ie, element: ce2 });
    if (te2 === "jump-next" || te2 === "jump-prev") {
      let se = (ye = ce2 == null ? void 0 : ce2.props) == null ? void 0 : ye.children;
      return (0, import_react80.createElement)(Ce2, { to: ie, element: import_react80.Children.count(se) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, se) : se });
    }
    return ce2;
  }, pageSize: A, current: D, simple: !N.sm, total: z2 == null ? void 0 : z2.total, onChange: X } : false, "antdPagination");
  return { searchFormProps: { form: Q, onFinish: J2 }, listProps: { dataSource: z2 == null ? void 0 : z2.data, loading: $ === "auto" ? Y : !G2, pagination: ee() }, queryResult: Z2, filters: c, setFilters: _, sorter: L, setSorter: j, sorters: v, setSorters: U, current: D, setCurrent: h, pageSize: A, setPageSize: K, pageCount: R, createLinkForSyncWithLocation: I, overtime: F };
}, "useSimpleList");
var Dm = o2(() => {
  let [e2, t] = (0, import_react81.useState)(false), r = (0, import_react81.useCallback)((s) => {
    as(s.fileList).includes(true) ? t(true) : t(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: r }), [e2]);
}, "useFileUploadState");
var as = o2((e2) => e2.map((t) => {
  switch (t.status) {
    case "uploading":
      return true;
    default:
...
var bt = o2(({ children: e2, initialSiderCollapsed: t }) => {
...
var ec = { open: ({ key: e2, message: t, description: r, type: s, cancelMutation: n2, undoableTimeout: i }) => {
  s === "progress" ? notification_default.open({ key: e2, description: import_react85.default.createElement(ht, { notificationKey: e2, message: t, cancelMutation: () => {
...
var tc = o2(() => {
  ...
  return { open: ({ key: s, message: n2, description: i, type: a, cancelMutation: l, undoableTimeout: u }) => {
    a === "progress" ? t.open({ key: s, description: import_react85.default.createElement(ht, { notificationKey: s, message: n2, cancelMutation: () => {
...
var fo = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Pt = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react88.useState)(false), [i, a] = (0, import_react88.useState)(false), l = qr(), u = Z(), y = rt(), { warnWhen: p, setWarnWhen: T } = dt(), { Link: d } = te(), f = u === "legacy" ? d : y, g = qn(), m = G(), { menuItems: b, selectedKey: x, defaultOpenKeys: C } = bu({ meta: r }), k = grid_default.useBreakpoint(), { hasDashboard: P } = ne(), S2 = J(), { mutate: B } = yr({ v3LegacyAuthProviderCompatible: !!(S2 != null && S2.isLegacy) }), v = typeof k.lg > "u" ? false : !k.lg, L = e2 ?? g ?? Ct2, c = o2((I, Z2) => I.map((F) => {
    let { icon: V, label: H, route: N, key: $, name: Q, children: z2, parentName: G2, meta: Y, options: X } = F;
    if (z2.length > 0)
      return import_react88.default.createElement(nc, { key: F.key, resource: Q.toLowerCase(), action: "list", params: { resource: F } }, import_react88.default.createElement(menu_default.SubMenu, { key: F.key, icon: V ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: H }, c(z2, Z2)));
    let J2 = $ === Z2, ee = !(S(Y == null ? void 0 : Y.parent, X == null ? void 0 : X.parent, G2) !== void 0 && z2.length === 0);
    return import_react88.default.createElement(nc, { key: F.key, resource: Q.toLowerCase(), action: "list", params: { resource: F } }, import_react88.default.createElement(menu_default.Item, { key: F.key, style: { fontWeight: J2 ? "bold" : "normal" }, icon: V ?? (ee && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(f, { to: N ?? "" }, H), !s && J2 && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), D = o2(() => {
    p ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (T(false), B()) : B();
  }, "handleLogout"), A = l && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: D, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), R = P ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: x === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(f, { to: "/" }, m("dashboard.title", "Dashboard")), !s && x === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, _ = c(b, x), h = o2(() => t ? t({ dashboard: R, items: _, logout: A, collapsed: s }) : import_react88.default.createElement(import_react88.default.Fragment, null, R, _, A), "renderSider"), K = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: x ? [x] : [], defaultOpenKeys: C, mode: "inline", onClick: () => {
    a(false), k.lg || n2(true);
  } }, h())), "renderMenu"), j = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(L, { collapsed: false }), K()))), import_react88.default.createElement(button_default, { style: fo, size: "large", onClick: () => a(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => v ? j() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (I) => n2(I), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(L, { collapsed: s }), K()), "renderContent")());
}, "Sider");
var Ft = o2(() => {
  let e2 = J(), { data: t } = $r({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
...
var Ms = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), l = r ?? Pt, u = t ?? Ft, y = typeof a.sm > "u" ? true : a.sm;
...
var Ct2 = o2(({ collapsed: e2 }) => {
  let t = Z(), r = rt(), { Link: s } = te();
...
var vt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react92.useState)(false), [a, l] = (0, import_react92.useState)(false), u = qr(), y = Z(), p = rt(), { warnWhen: T, setWarnWhen: d } = dt(), { Link: f } = te(), g = y === "legacy" ? f : p, m = qn(), b = G(), { menuItems: x, selectedKey: C, defaultOpenKeys: k } = bu({ meta: r }), P = grid_default.useBreakpoint(), { hasDashboard: S2 } = ne(), B = J(), { mutate: v } = yr({ v3LegacyAuthProviderCompatible: !!(B != null && B.isLegacy) }), L = typeof P.lg > "u" ? false : !P.lg, c = e2 ?? m ?? Lt, D = o2((I, Z2) => I.map((F) => {
    let { icon: V, label: H, route: N, key: $, name: Q, children: z2, parentName: G2, meta: Y, options: X } = F;
    if (z2.length > 0)
      return import_react92.default.createElement(nc, { key: F.key, resource: Q.toLowerCase(), action: "list", params: { resource: F } }, import_react92.default.createElement(menu_default.SubMenu, { key: F.key, icon: V ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: H }, D(z2, Z2)));
    let J2 = $ === Z2, ee = !(S(Y == null ? void 0 : Y.parent, X == null ? void 0 : X.parent, G2) !== void 0 && z2.length === 0);
    return import_react92.default.createElement(nc, { key: F.key, resource: Q.toLowerCase(), action: "list", params: { resource: F } }, import_react92.default.createElement(menu_default.Item, { key: F.key, icon: V ?? (ee && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(g, { to: N ?? "" }, H), !n2 && J2 && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), A = o2(() => {
    T ? window.confirm(b("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (d(false), v()) : v();
  }, "handleLogout"), R = u && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => A(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, b("buttons.logout", "Logout")), _ = S2 ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(g, { to: "/" }, b("dashboard.title", "Dashboard")), !n2 && C === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, h = D(x, C), K = o2(() => t ? t({ dashboard: _, items: h, logout: R, collapsed: n2 }) : import_react92.default.createElement(import_react92.default.Fragment, null, _, h, R), "renderSider"), j = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: C ? [C] : [], defaultOpenKeys: k, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    l(false), P.lg || i(true);
  } }, K())), "renderMenu"), U = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: a, onClose: () => l(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react92.default.createElement(c, { collapsed: false })), j()))), import_react92.default.createElement(button_default, { style: ho, size: "large", onClick: () => l(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return L ? U() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (I) => i(I), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react92.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(c, { collapsed: n2 })), j());
}, "ThemedSider");
var kt = o2(() => {
  let { token: e2 } = theme_default.useToken(), t = J(), { data: r } = $r({ v3LegacyAuthProviderCompatible: !!(t != null && t.isLegacy) });
...
var gn = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), l = r ?? vt, u = t ?? kt, y = typeof a.sm > "u" ? true : a.sm;
...
var So = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Et = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: l, mobileSiderOpen: u, setMobileSiderOpen: y } = yo(), p = qr(), T = Z(), d = rt(), { warnWhen: f, setWarnWhen: g } = dt(), { Link: m } = te(), b = T === "legacy" ? m : d, x = qn(), C = G(), { menuItems: k, selectedKey: P, defaultOpenKeys: S2 } = bu({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: v } = ne(), L = J(), { mutate: c } = yr({ v3LegacyAuthProviderCompatible: !!(L != null && L.isLegacy) }), D = typeof B.lg > "u" ? false : !B.lg, A = e2 ?? x ?? ge2, R = o2((V, H) => V.map((N) => {
    let { icon: $, label: Q, route: z2, key: G2, name: Y, children: X, parentName: J2, meta: ee, options: O } = N;
    if (X.length > 0)
      return import_react96.default.createElement(nc, { key: N.key, resource: Y.toLowerCase(), action: "list", params: { resource: N } }, import_react96.default.createElement(menu_default.SubMenu, { key: N.key, icon: $ ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: Q }, R(X, H)));
    let te2 = G2 === H, ce2 = !(S(ee == null ? void 0 : ee.parent, O == null ? void 0 : O.parent, J2) !== void 0 && X.length === 0), ie = n2 && te2 ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(nc, { key: N.key, resource: Y.toLowerCase(), action: "list", params: { resource: N } }, import_react96.default.createElement(menu_default.Item, { key: N.key, icon: $ ?? (ce2 && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: ie }, import_react96.default.createElement(b, { to: z2 ?? "", style: ie }, Q), !a && te2 && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), _ = o2(() => {
    f ? window.confirm(C("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (g(false), c()) : c();
  }, "handleLogout"), h = p && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => _(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, C("buttons.logout", "Logout")), K = v ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(b, { to: "/" }, C("dashboard.title", "Dashboard")), !a && P === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, j = R(k, P), U = o2(() => t ? t({ dashboard: K, items: j, logout: h, collapsed: a }) : import_react96.default.createElement(import_react96.default.Fragment, null, K, j, h), "renderSider"), I = o2(() => import_react96.default.createElement(menu_default, { selectedKeys: P ? [P] : [], defaultOpenKeys: S2, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, U()), "renderMenu"), Z2 = o2(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react96.default.createElement(A, { collapsed: false })), I()))), import_react96.default.createElement(button_default, { style: So, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (D)
    return Z2();
  let F = { backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` };
  return s && (F.position = "fixed", F.top = 0, F.height = "100vh", F.zIndex = 999), import_react96.default.createElement(import_react96.default.Fragment, null, s && import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: F, collapsible: true, collapsed: a, onCollapse: (V, H) => {
    H === "clickTrigger" && l(V);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react96.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, a ? import_react96.default.createElement(RightOutlined_default, { style: { color: i.colorPrimary } }) : import_react96.default.createElement(LeftOutlined_default, { style: { color: i.colorPrimary } })) }, import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react96.default.createElement(A, { collapsed: a })), I()));
}, "ThemedSiderV2");
var Rt = o2(({ isSticky: e2, sticky: t }) => {
  let { token: r } = theme_default.useToken(), s = J(), { data: n2 } = $r({ v3LegacyAuthProviderCompatible: !!(s != null && s.isLegacy) });
...
var ea = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a }) => {
  let l = grid_default.useBreakpoint(), u = r ?? Et, y = t ?? Rt, p = typeof l.sm > "u" ? true : l.sm, T = !!u({ Title: s });
  return import_react95.default.createElement(bt, { initialSiderCollapsed: a }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: T }, import_react95.default.createElement(u, { Title: s }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: p ? 24 : 12 } }, e2), i && import_react95.default.createElement(i, null)), n2 && import_react95.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var ge2 = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  let { title: { icon: n2, text: i } = {} } = Ct(), a = typeof t > "u" ? n2 : t, l = typeof r > "u" ? i : r, { token: u } = theme_default.useToken(), y = Z(), p = rt(), { Link: T } = te();
  return import_react98.default.createElement(y === "legacy" ? T : p, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react98.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react98.default.createElement("div", { style: { height: "24px", width: "24px", color: u.colorPrimary } }, a), !e2 && import_react98.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, l)));
}, "ThemedTitleV2");
var At2 = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  let { hidden: u, disabled: y, label: p, title: T, LinkComponent: d, to: f } = Jb({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return u ? null : import_react99.default.createElement(d, { to: f, replace: false, onClick: (g) => {
    if (y) {
      g.preventDefault();
      return;
    }
    a && (g.preventDefault(), a(g));
  } }, import_react99.default.createElement(button_default, { icon: import_react99.default.createElement(PlusSquareOutlined_default, null), disabled: y, title: T, className: n.CreateButton, type: "primary", ...l }, !r && (i ?? p)));
}, "CreateButton");
var Ht = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, label: p, title: T, hidden: d, disabled: f, LinkComponent: g } = Zb({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 });
  ...
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: f, title: T, className: n.EditButton, ...u }, !s && (a ?? p)));
}, "EditButton");
var $e = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: l, hideText: u = false, accessControl: y, metaData: p, meta: T, dataProviderName: d, confirmTitle: f, confirmOkText: g, confirmCancelText: m, invalidates: b, ...x }) => {
  let { title: C, label: k, hidden: P, disabled: S2, loading: B, confirmTitle: v, confirmOkLabel: L, cancelLabel: c, onConfirm: D } = Lu({ resource: e2 ?? t, id: r, dataProviderName: d, invalidates: b, meta: T, onSuccess: s, mutationMode: n2, errorNotification: l, successNotification: a, accessControl: y });
  return P ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: g ?? L, cancelText: m ?? c, okType: "danger", title: f ?? v, okButtonProps: { disabled: B }, onConfirm: D, disabled: typeof (x == null ? void 0 : x.disabled) < "u" ? x.disabled : S2 }, import_react101.default.createElement(button_default, { danger: true, loading: B, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: C, disabled: S2, className: n.DeleteButton, ...x }, !u && (i ?? k)));
}, "DeleteButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: l, ...u }) => {
  let { onClick: y, label: p, loading: T } = Eu({ resource: e2 ?? t, id: r, dataProviderName: n2 });
  return import_react102.default.createElement(button_default, { onClick: y, icon: import_react102.default.createElement(RedoOutlined_default, { spin: T }), className: n.RefreshButton, ...u }, !s && (i ?? p));
}, "RefreshButton");
var Va = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, label: p, title: T, hidden: d, disabled: f, LinkComponent: g } = Xb({ resource: e2 ?? t, id: r, accessControl: n2, meta: i });
  return d ? null : import_react103.default.createElement(g, { to: y, replace: false, onClick: (m) => {
    ...
    l && (m.preventDefault(), l(m));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: f, title: T, className: n.ShowButton, ...u }, !s && (a ?? p)));
}, "ShowButton");
var _e = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  let { to: u, label: y, title: p, hidden: T, disabled: d, LinkComponent: f } = qb({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return T ? null : import_react104.default.createElement(f, { to: u, replace: false, onClick: (g) => {
    if (d) {
      g.preventDefault();
      return;
    }
...
var Ga = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = tv();
...
var Ze = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = ev();
...
var oi = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, LinkComponent: p, label: T, disabled: d, hidden: f, title: g } = Yb({ id: r, resource: t ?? e2, accessControl: n2, meta: i });
  return f ? null : import_react107.default.createElement(p, { to: y, replace: false, onClick: (m) => {
    if (d) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: d, title: g, className: n.CloneButton, ...u }, !s && (a ?? T)));
}, "CloneButton");
var li = o2(({ uploadProps: e2, buttonProps: t, hideText: r = false, children: s, loading: n2 }) => {
  let { label: i } = rv();
...
var Ti = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: l, breadcrumb: u, headerButtonProps: y, headerButtons: p }) => {
  var S2, B;
  let T = G(), { options: { breadcrumb: d } = {} } = ne(), f = Z(), g = nt(), { resource: m, identifier: b } = z(n2), x = e2 ?? (((m == null ? void 0 : m.canCreate) ?? !!(m != null && m.create)) || s), C = typeof u > "u" ? d : u, k = x ? { size: "middle", resource: f === "legacy" ? m == null ? void 0 : m.route : b, ...s } : void 0, P = x ? import_react109.default.createElement(At2, { ...k }) : null;
  return import_react109.default.createElement("div", { ...i ?? {} }, import_react109.default.createElement(Le, { ghost: false, title: t ?? T(`${b}.titles.list`, g(((S2 = m == null ? void 0 : m.meta) == null ? void 0 : S2.label) ?? ((B = m == null ? void 0 : m.options) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? b, "plural")), extra: p ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof p == "function" ? p({ defaultButtons: P, createButtonProps: k }) : p) : P, breadcrumb: typeof C < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, C) ?? void 0 : import_react109.default.createElement(ve, null), ...l ?? {} }, import_react109.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var vi = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: l, contentProps: u, headerButtonProps: y, headerButtons: p, footerButtonProps: T, footerButtons: d, goBack: f }) => {
  var D, A;
  let g = G(), { options: { breadcrumb: m } = {} } = ne(), b = Z(), x = co(), { goBack: C } = ce(), k = nt(), { resource: P, action: S2, identifier: B } = z(s), v = typeof i > "u" ? m : i, L = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, c = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Ze, { ...L }));
  return import_react110.default.createElement("div", { ...a ?? {} }, import_react110.default.createElement(Le, { ghost: false, backIcon: f, onBack: S2 !== "list" || typeof S2 < "u" ? b === "legacy" ? C : x : void 0, title: e2 ?? g(`${B}.titles.create`, `Create ${k(((D = P == null ? void 0 : P.meta) == null ? void 0 : D.label) ?? ((A = P == null ? void 0 : P.options) == null ? void 0 : A.label) ?? (P == null ? void 0 : P.label) ?? B, "singular")}`), breadcrumb: typeof v < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, v) ?? void 0 : import_react110.default.createElement(ve, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: null }) : p : null), ...l ?? {} }, import_react110.default.createElement(spin_default, { spinning: n2 }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...T ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: c, saveButtonProps: L }) : d : c)], ...u ?? {} }, r))));
}, "Create");
var Mi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: l, isLoading: u = false, dataProviderName: y, breadcrumb: p, wrapperProps: T, headerProps: d, contentProps: f, headerButtonProps: g, headerButtons: m, footerButtonProps: b, footerButtons: x, goBack: C, autoSaveProps: k }) => {
  var X, J2, ee;
  let P = G(), { options: { breadcrumb: S2 } = {} } = ne(), { mutationMode: B } = ke(), v = r ?? B, L = Z(), c = co(), D = ge(), { goBack: A, list: R } = ce(), _ = nt(), { resource: h, action: K, id: j, identifier: U } = z(l), I = nu({ resource: h, action: "list" }), Z2 = s ?? j, F = typeof p > "u" ? S2 : p, V = (h == null ? void 0 : h.list) && !s, H = a ?? ((((X = h == null ? void 0 : h.meta) == null ? void 0 : X.canDelete) ?? (h == null ? void 0 : h.canDelete)) || i), N = V ? { ...u ? { disabled: true } : {}, resource: L === "legacy" ? h == null ? void 0 : h.route : U } : void 0, $ = { ...u ? { disabled: true } : {}, resource: L === "legacy" ? h == null ? void 0 : h.route : U, recordItemId: Z2, dataProviderName: y }, Q = H ? { ...u ? { disabled: true } : {}, resource: L === "legacy" ? h == null ? void 0 : h.route : U, mutationMode: v, onSuccess: () => {
    L === "legacy" ? R((h == null ? void 0 : h.route) ?? (h == null ? void 0 : h.name) ?? "") : D({ to: I });
  }, recordItemId: Z2, dataProviderName: y, ...i } : void 0, z2 = { ...u ? { disabled: true } : {}, ...t }, G2 = import_react111.default.createElement(import_react111.default.Fragment, null, k && import_react111.default.createElement(Ao, { ...k }), V && import_react111.default.createElement(_e, { ...N }), import_react111.default.createElement(Ye, { ...$ })), Y = import_react111.default.createElement(import_react111.default.Fragment, null, H && import_react111.default.createElement($e, { ...Q }), import_react111.default.createElement(Ze, { ...z2 }));
  return import_react111.default.createElement("div", { ...T ?? {} }, import_react111.default.createElement(Le, { ghost: false, backIcon: C, onBack: K !== "list" && typeof K < "u" ? L === "legacy" ? A : c : void 0, title: e2 ?? P(`${U}.titles.edit`, `Edit ${_(((J2 = h == null ? void 0 : h.meta) == null ? void 0 : J2.label) ?? ((ee = h == null ? void 0 : h.options) == null ? void 0 : ee.label) ?? (h == null ? void 0 : h.label) ?? U, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...g ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: G2, listButtonProps: N, refreshButtonProps: $ }) : m : G2), breadcrumb: typeof F < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, F) ?? void 0 : import_react111.default.createElement(ve, null), ...d ?? {} }, import_react111.default.createElement(spin_default, { spinning: u }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...b ?? {} }, x ? typeof x == "function" ? x({ defaultButtons: Y, deleteButtonProps: Q, saveButtonProps: z2 }) : x : Y)], ...f ?? {} }, n2))));
}, "Edit");
var Zi = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: l, breadcrumb: u, contentProps: y, headerProps: p, wrapperProps: T, headerButtons: d, footerButtons: f, footerButtonProps: g, headerButtonProps: m, goBack: b }) => {
  var $, Q, z2;
  let x = G(), { options: { breadcrumb: C } = {} } = ne(), k = Z(), P = co(), S2 = ge(), { goBack: B, list: v } = ce(), L = nt(), { resource: c, action: D, id: A, identifier: R } = z(i), _ = nu({ resource: c, action: "list" }), h = a ?? A, K = typeof u > "u" ? C : u, j = (c == null ? void 0 : c.list) && !a, U = r ?? (($ = c == null ? void 0 : c.meta) == null ? void 0 : $.canDelete) ?? (c == null ? void 0 : c.canDelete), I = t ?? (c == null ? void 0 : c.canEdit) ?? !!(c != null && c.edit), Z2 = j ? { resource: k === "legacy" ? c == null ? void 0 : c.route : R } : void 0, F = I ? { ...s ? { disabled: true } : {}, type: "primary", resource: k === "legacy" ? c == null ? void 0 : c.route : R, recordItemId: h } : void 0, V = U ? { ...s ? { disabled: true } : {}, resource: k === "legacy" ? c == null ? void 0 : c.route : R, recordItemId: h, onSuccess: () => {
    k === "legacy" ? v((c == null ? void 0 : c.route) ?? (c == null ? void 0 : c.name) ?? "") : S2({ to: _ });
  }, dataProviderName: l } : void 0, H = { ...s ? { disabled: true } : {}, resource: k === "legacy" ? c == null ? void 0 : c.route : R, recordItemId: h, dataProviderName: l }, N = import_react112.default.createElement(import_react112.default.Fragment, null, j && import_react112.default.createElement(_e, { ...Z2 }), I && import_react112.default.createElement(Ht, { ...F }), U && import_react112.default.createElement($e, { ...V }), import_react112.default.createElement(Ye, { ...H }));
  return import_react112.default.createElement("div", { ...T ?? {} }, import_react112.default.createElement(Le, { ghost: false, backIcon: b, onBack: D !== "list" && typeof D < "u" ? k === "legacy" ? B : P : void 0, title: e2 ?? x(`${R}.titles.show`, `Show ${L(((Q = c == null ? void 0 : c.meta) == null ? void 0 : Q.label) ?? ((z2 = c == null ? void 0 : c.options) == null ? void 0 : z2.label) ?? (c == null ? void 0 : c.label) ?? R, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...m ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: N, deleteButtonProps: V, editButtonProps: F, listButtonProps: Z2, refreshButtonProps: H }) : d : N), breadcrumb: typeof K < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, K) ?? void 0 : import_react112.default.createElement(ve, null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: s }, import_react112.default.createElement(card_default, { bordered: false, actions: f ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...g }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...y ?? {} }, n2))));
}, "Show");
var ep = o2(({ value: e2, ...t }) => import_react113.default.createElement(typography_default.Text, { ...t }, e2), "TextField");
var rp = o2(({ value: e2, ...t }) => import_react114.default.createElement(tag_default, { ...t }, e2 == null ? void 0 : e2.toString()), "TagField");
var ap = o2(({ value: e2, ...t }) => import_react115.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...t }, e2), "EmailField");
var lp = o2(({ value: e2, imageTitle: t, ...r }) => import_react116.default.createElement(image_default, { ...r, src: e2, title: t }), "ImageField");
var cp = o2(({ value: e2, valueLabelTrue: t = "true", valueLabelFalse: r = "false", trueIcon: s = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react117.default.createElement(CloseOutlined_default, null), ...i }) => import_react117.default.createElement(tooltip_default, { title: e2 ? t : r, ...i }, e2 ? import_react117.default.createElement("span", null, s) : import_react117.default.createElement("span", null, n2)), "BooleanField");
var gp = o2(({ value: e2, locales: t, format: r = "L", ...s }) => {
...
var hp = o2(({ title: e2, src: t, ...r }) => import_react119.default.createElement(Wt, { value: t, title: e2, ...r }, e2 ?? t), "FileField");
var Wt = o2(({ children: e2, value: t, ...r }) => import_react120.default.createElement(typography_default.Link, { href: t, ...r }, e2 ?? t), "UrlField");
function Bp() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
o2(Bp, "toLocaleStringSupportsOptions");
var Sp = o2(({ value: e2, locale: t, options: r, ...s }) => {
  let n2 = Number(e2);
  return import_react121.default.createElement(typography_default.Text, { ...s }, Bp() ? n2.toLocaleString(t, r) : n2);
}, "NumberField");
var Dp = o2(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Ip = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((d) => d, "mapValue"), selectedKeys: i, children: a } = e2, l = G(), u = o2(() => {
    ...
    let f = n2(d, "onChange");
    t(f);
  }, "onChange"), T = import_react123.default.Children.map(a, (d) => import_react123.default.isValidElement(d) ? import_react123.default.cloneElement(d, { onChange: p, value: n2(i, "value") }) : d);
  return import_react123.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react123.default.createElement("div", { style: { marginBottom: 15 } }, T), import_react123.default.createElement(space_default, null, import_react123.default.createElement(button_default, { type: "primary", size: "small", onClick: () => y() }, import_react123.default.createElement(FilterOutlined_default, null), " ", l("buttons.filter", "Filter")), import_react123.default.createElement(button_default, { danger: true, size: "small", onClick: () => u() }, l("buttons.clear", "Clear"))));
}, "FilterDropdown");
var qp = o2(() => {
  let [e2, t] = (0, import_react124.useState)(), r = G(), { push: s } = ce(), n2 = ge(), i = Z(), { resource: a, action: l } = z();
...
var No = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var Qo = { maxWidth: "408px", margin: "auto" };
var zo = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var jo = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var ol = o2(() => {
  let [e2] = form_default.useForm(), t = G(), r = J(), { mutate: s, isLoading: n2 } = At({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), i = import_react125.default.createElement(typography_default.Title, { level: 3, style: zo }, t("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: No }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Qo }, import_react125.default.createElement("div", { style: jo }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    s(a);
...
var dl = o2(() => re.createElement(row_default, { align: "middle", justify: "center", style: He.root }, re.createElement(col_default, { style: { textAlign: "center" } }, re.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), re.createElement(typography_default.Title, { style: He.title }, "Welcome on board"), re.createElement("p", { style: He.p1 }, "Your configuration is completed."), re.createElement("p", { style: He.p2 }, "Now you can get started by adding your resources to the", " ", re.createElement("code", { style: He.code }, "resources"), " property of", " ", re.createElement("code", { style: He.code }, "<Refine>")), re.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, re.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, re.createElement(button_default, { size: "large", icon: re.createElement(ReadOutlined_default, null) }, "Documentation")), re.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, re.createElement(button_default, { size: "large", icon: re.createElement(FolderOutlined_default, null) }, "Examples")), re.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, re.createElement(button_default, { size: "large", icon: re.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
var cl = o2(() => import_react126.default.createElement(Ku, null), "WelcomePage");
var ke2 = {};
...
var Kt = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: l, title: u, hideForm: y }) => {
  let { token: p } = theme_default.useToken(), [T] = form_default.useForm(), d = G(), f = Z(), g = rt(), { Link: m } = te(), b = f === "legacy" ? m : g, x = J(), { mutate: C, isLoading: k } = At({ v3LegacyAuthProviderCompatible: !!(x != null && x.isLegacy) }), P = u === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, u ?? import_react128.default.createElement(ge2, { collapsed: false })), S2 = import_react128.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Re } }, d("pages.login.title", "Sign in to your account")), B = o2(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((L) => import_react128.default.createElement(button_default, { key: L.name, type: "default", block: true, icon: L.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ providerName: L.name }) }, L.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(typography_default.Text, { style: { color: p.colorTextLabel } }, d("pages.login.divider", "or")))) : null, "renderProviders"), v = import_react128.default.createElement(card_default, { title: S2, headStyle: we, bodyStyle: Ee, style: { ...De, backgroundColor: p.colorBgElevated }, ...n2 ?? {} }, B(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: T, onFinish: (L) => C(L), requiredMark: false, initialValues: { remember: false }, ...l }, import_react128.default.createElement(form_default.Item, { name: "email", label: d("pages.login.fields.email", "Email"), rules: [{ required: true, message: d("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: d("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: d("pages.login.fields.password", "Password"), rules: [{ required: true, message: d("pages.login.errors.requiredPassword", "Password is required") }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, d("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react128.default.createElement(b, { style: { color: p.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, d("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: k, block: true }, d("pages.login.signin", "Sign in")))), t ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(b, { to: "/register", style: { fontWeight: "bold", color: p.colorPrimaryTextHover } }, d("pages.login.signup", "Sign up")))));
...
var _t = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2 }) => {
  ...
  return import_react131.default.createElement(layout_default, { style: ke2, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, r ? r(f, T) : import_react131.default.createElement(import_react131.default.Fragment, null, T, f))));
}, "UpdatePasswordPage");
var id = o2((e2) => {
  let { type: t } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, o2(() => {
    switch (t) {
      ...
      default:
        return import_react127.default.createElement(Kt, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var ve = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s }) => {
  let n2 = Z(), { breadcrumbs: i } = TC({ meta: s }), a = rt(), { Link: l } = te(), { hasDashboard: u } = ne(), { resources: y } = z(), p = Go("/", y), T = n2 === "legacy" ? l : a;
  if (i.length === 1)
    return null;
  let d = i.map(({ label: g, icon: m, href: b }) => ({ key: `breadcrumb-item-${g}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && m, b ? import_react132.default.createElement(T, { to: b }, g) : import_react132.default.createElement("span", null, g)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: o2(() => {
    var g, m;
    return t && (u || p.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(T, { to: "/" }, ((m = (g = p == null ? void 0 : p.resource) == null ? void 0 : g.meta) == null ? void 0 : m.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...d] : d;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var Le = o2(({ children: e2, ...t }) => {
  let r = typeof t.backIcon > "u" ? import_react133.default.createElement(button_default, { type: "text", icon: import_react133.default.createElement(ArrowLeftOutlined_default, null) }) : t.backIcon, s = typeof t.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, t.title) : t.title, n2 = typeof t.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, t.subTitle) : t.subTitle;
  return import_react133.default.createElement(PageHeader, { ...t, backIcon: r, title: s, subTitle: n2, style: { padding: 0, ...t.style } }, e2);
}, "PageHeader");
var Ao = o2(({ status: e2, elements: { success: t = import_react134.default.createElement(dt2, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: r = import_react134.default.createElement(dt2, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: s = import_react134.default.createElement(dt2, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react134.default.createElement(dt2, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(pc, { status: e2, elements: { success: t, error: r, loading: s, idle: n2 } }), "AutoSaveIndicator");
var dt2 = o2(({ key: e2, defaultMessage: t, icon: r }) => {
...
var kd = o2((e2, t) => e2 && (t === "value" ? e2.map((r) => typeof r == "string" ? (0, import_dayjs7.default)(r) : r) : t === "onChange" && e2.every(import_dayjs7.default.isDayjs) ? e2.map((r) => (0, import_dayjs7.default)(r).toISOString()) : e2), "rangePickerFilterMapper");
var Dd = o2((e2) => {
  let { fileList: t } = e2;
  return [...t];
}, "getValueFromEvent");
var ex = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  id as AuthPage,
  Ao as AutoSaveIndicator,
  cp as BooleanField,
  ve as Breadcrumb,
  oi as CloneButton,
  vi as Create,
  ...
  ep as TextField,
  kt as ThemedHeader,
  Rt as ThemedHeaderV2,
  gn as ThemedLayout,
  Ae as ThemedLayoutContext,
  bt as ThemedLayoutContextProvider,
  ea as ThemedLayoutV2,
  vt as ThemedSider,
  Et as ThemedSiderV2,
  Lt as ThemedTitle,
  ...
  Wt as UrlField,
  cl as WelcomePage,
  kr as getDefaultFilter,
  Lr as getDefaultSortOrder,
  Dd as getValueFromEvent,
  yt as mapAntdFilterToCrudFilter,
  ct as mapAntdSorterToCrudSorting,
  ec as notificationProvider,
  kd as rangePickerFilterMapper,
  am as useCheckboxGroup,
  so as useDrawerForm,
  zr as useEditableTable,
  Dm as useFileUploadState,
  he as useForm,
  Tm as useImport,
  eo as useModal,
  oo as useModalForm,
  tc as useNotificationProvider,
  dm as useRadioGroup,
  om as useSelect,
  Mm as useSiderVisible,
  os as useSimpleList,
  no as useStepsForm,
  Tt as useTable,
  yo as useThemedLayoutContext
};
